...
export function AboutProjects() {
  ...
  return (
    <section ref={sectionRef} id="about" className="scroll-mt-24 bg-white py-16 text-dark">
      <div className="mx-auto grid w-full max-w-[1100px] gap-12 px-8 lg:grid-cols-2 lg:items-center">
        <div ref={leftRef} className="max-w-[500px]">
          <p className="font-oswald text-[10px] font-bold uppercase tracking-[2.2px] text-primary mb-3">
            About VTRAX Projects
          </p>
          <h2 className="font-oswald text-[44px] sm:text-[54px] font-extrabold uppercase leading-[1.05] text-dark mb-4">
            Locally Owned.<br />
            <span className="text-primary">Illawarra Built.</span>
          </h2>
          <p className="font-open-sans text-[13px] font-normal leading-[1.7] text-dark mb-4">
          ...
          <a
            href="#contact"
            className="inline-flex h-[46px] items-center justify-center rounded-[1px] border border-dark bg-transparent px-7 font-oswald text-[13px] font-bold uppercase tracking-[1.7px] text-dark transition hover:bg-dark hover:text-white"
          >
        ...
        <div ref={rightRef} className="relative flex flex-col items-end">
          <div className="relative w-full max-w-[420px] h-[540px]">
            ...
            <div className="absolute -left-6 bottom-0 translate-y-6 flex h-[88px] w-[86px] flex-col justify-center bg-primary px-3 pb-2 pt-2 text-dark shadow-lg">
              <span className="font-oswald text-[42px] font-bold leading-[1]">8</span>
              <span className="font-oswald text-[7.5px] font-bold uppercase leading-[1.5] tracking-[1.6px]">
                Years<br />Experience
              </span>
            </div>
          </div>
